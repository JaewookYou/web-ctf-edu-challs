...
insert into sqli1_table (userid, userpw) values ("guest","guest"), ("admin", "aghiwerhgioarwhg"); # admin password 가리기
insert into sqli2_table (userid, userpw) values ("guest","guest"), ("admin", "ajweifojawieofja"); # admin password 가리기
insert into sqli3_table (userid, userpw) values ("guest","guest"), ("admin", "flag{sqli3}"); # admin password 가리기
